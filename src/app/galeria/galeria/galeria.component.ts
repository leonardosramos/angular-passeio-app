...
export class GaleriaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    .subscribe(lugares => this.lugaresLista = lugares)
  }
  ...
  filtrar(){
    this.lugarService.filtrar(this.nomeFiltro, this.categoriaFiltro).subscribe(resultado => this.lugaresLista = resultado);
  }
